...
echo $i" |"$cy"     LIKE | SHARE | SUBSCRIBE "$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" MR HACKER "$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Khokan Das"$i"                   |"
echo $i" |"$pu" INSTAGRAM  :"$cy"~ IMPISH_KHOKA"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 918906791455"$i"             |"
echo $i" |"$pu" Contact Gmail :"$ku" khoka.kd@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" BRUTEFORCE FB PHP        "$i"|"$i"    |"$cy" MR"$i" |"
echo $i"|"$me" 2"$i" |"$cy" BRUTEFORCE FB CRACK      "$i"|"$i"    |"$cy" H"$i" |"
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB iqbalzb     "$i"|"$i"    |"$cy"A "$i" |"
echo $i"|"$me" 4"$i" |"$cy" BRUTEFORCE FB MBF        "$i"|"$i"    |"$cy" C"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACEBRUTE N1ght420       "$i"|"$i"    |"$cy" K "$i" |"

echo $i"|"$me" 6"$i" |"$cy" BRUTEFORCE FB ( root )   "$i"|"$i"    |"$cy" R"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" L"$i" |"
...
echo $i"────────────────────────────────"$i"    |"$cy" R"$i" |"
echo $i"|"$me"18"$i" |"$cy" INSTALL BAHAN DULU COEG  "$i"|"$i"    |"$cy" O"$i" |"
echo $i"|"$me"19"$i" |"$cy" EXIT   ---- PROGRAM      "$i"|"$i"    |"$cy" L"$i" |"
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"SUBSCRIBE $bi"]"$me"======"$bi"["$i""Mr Hacker ""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $cy" Subscribe My Channel"
sleep 2
echo $i"Any Problem Join My Group,  Link in Description "
sleep 2
echo $ku"WhatsApp :"$i" 918906791455"
echo $ku"Facebook :"$i" Khokan Das"
sleep 2
