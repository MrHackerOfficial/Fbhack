...
echo $i" |"$pu"  INSTAGRAM :"$cy"~ FOLLOW ME - Impish_khoka"$i"  |"
echo $i" |"$cy"            ~ "$i" |"
...
echo $i"|"$me" 4"$i" |"$cy" BRUTEFORCE FB MBF        "$i"|"$i"    |"$cy" M"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACEBRUTE N1ght420       "$i"|"$i"    |"$cy" U"$i" |"
echo $i"|"$me" 6"$i" |"$cy" BRUTEFORCE FB ( root )   "$i"|"$i"    |"$cy" X"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" "$i" |"
...
echo $i"────────────────────────────────"$i"    |"$cy" "$i" |"
echo $i"|"$me"18"$i" |"$cy"    INSTALL ALL TOOL      "$i"|"$i"    |"$cy" C"$i" |"
echo $i"|"$me"19"$i" |"$cy"     EXIT    PROGRAM      "$i"|"$i"    |"$cy" K"$i" |"
echo $i"────────────────────────────────    ─────"
echo
